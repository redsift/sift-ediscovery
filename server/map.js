/**
 * Sift Ediscovery. DAG's 'Map' node implementation
 */
...
module.exports = function(got) {
  ...
  console.log('sift-ediscovery: map.js: running...');
  
  var result = inData.data.map(function(datum){
    var jmapInfo = JSON.parse(datum.value);
    console.log('sift-ediscovery: map.js: inData: key', datum.key);
    console.log('sift-ediscovery: map.js: inData: value', jmapInfo);
